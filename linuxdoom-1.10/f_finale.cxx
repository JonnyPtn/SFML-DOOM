...
castinfo_t castorder[] = {{CC_ZOMBIE, MT_POSSESSED}, {CC_SHOTGUN, MT_SHOTGUY}, {CC_HEAVY, MT_CHAINGUY}, {CC_IMP, MT_TROOP},     {CC_DEMON, MT_SERGEANT},
                          {CC_LOST, MT_SKULL},       {CC_CACO, MT_HEAD},       {CC_HELL, MT_KNIGHT},    {CC_BARON, MT_BRUISER}, {CC_ARACH, MT_BABY},
                          {CC_PAIN, MT_PAIN},        {CC_REVEN, MT_UNDEAD},    {CC_MANCU, MT_FATSO},    {CC_ARCH, MT_VILE},     {CC_SPIDER, MT_SPIDER},
                          {CC_CYBER, MT_CYBORG},     {CC_HERO, MT_PLAYER},
...
void F_CastDrawer(void)
{
    ...
    patch = (patch_t *)W_CacheLumpNum(lump + firstspritelump);
    if (flip)
...
void F_BunnyScroll(void)
{
    ...
    p1 = (patch_t *)W_CacheLumpName("PFUB2");
    p2 = (patch_t *)W_CacheLumpName("PFUB1");
    ...
    if (finalecount < 1180)
    {
        V_DrawPatch((SCREENWIDTH - 13 * 8) / 2, (SCREENHEIGHT - 8 * 8) / 2, 0, (patch_t *)W_CacheLumpName("END0"));
        laststage = 0;
        return;
    }
    ...
    V_DrawPatch((SCREENWIDTH - 13 * 8) / 2, (SCREENHEIGHT - 8 * 8) / 2, 0, (patch_t *)W_CacheLumpName(name));
}
...
void F_Drawer(void)
{
    ...
    else
    {
        ...
        case 1:
            if (gamemode == retail)
                V_DrawPatch(0, 0, 0, (patch_t *)W_CacheLumpName("CREDIT"));
            else
                V_DrawPatch(0, 0, 0, (patch_t *)W_CacheLumpName("HELP2"));
            break;
        case 2:
            V_DrawPatch(0, 0, 0, (patch_t *)W_CacheLumpName("VICTORY2"));
            break;
        case 3:
            F_BunnyScroll();
            break;
        case 4:
            V_DrawPatch(0, 0, 0, (patch_t *)W_CacheLumpName("ENDPIC"));
            break;
        }
    }
}