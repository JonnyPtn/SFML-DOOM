...
{
    // JONNY TODO return (int)&(((doomdata_t *)0)->cmds[netbuffer->numtics]);
    return 0;
}
...
boolean HGetPacket(void)
{
    ...
    if (debugfile)
    {
        ...
        else
        {
            ...
            fprintf(debugfile, "get %i = (%i + %i, R %i)[%i] ", doomcom->remotenode, ExpandTics(netbuffer->starttic), netbuffer->numtics, realretrans,
                    doomcom->datalength);
