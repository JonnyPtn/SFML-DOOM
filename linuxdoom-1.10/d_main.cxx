...
void D_Display(void)
{
    ...
    if (paused)
    {
        if (automapactive)
            ...
            y = viewwindowy + 4;
        V_DrawPatchDirect(viewwindowx + (scaledviewwidth - 68) / 2, y, 0, (const patch_t *)W_CacheLumpName("M_PAUSE"));
    }
...
// D_PageDrawer
//
void D_PageDrawer(void) { V_DrawPatch(0, 0, 0, (const patch_t *)W_CacheLumpName(pagename)); }
    ...
    */
    ...
    if (modifiedgame)
    {
        ...
        char name[23][8] = {
            ...
            "e3m4", "e3m5", "e3m6", "e3m7", "e3m8", "e3m9", "dphoof", "bfgga0", "heada1", "cybra1" /*,"spida1d1"*/ // JONNY NOTE: not sure if this last name is
                                                                                                                   // needed but it's the wrong size
        };
        int i;
