...
#define R (FRACUNIT)
mline_t triangle_guy[] = {{{static_cast<fixed_t>(-.867 * R), static_cast<fixed_t>(-.5 * R)}, {static_cast<fixed_t>(.867 * R), static_cast<fixed_t>(-.5 * R)}},
...
#define R (FRACUNIT)
mline_t thintriangle_guy[] = {{{static_cast<fixed_t>(-.5 * R), static_cast<fixed_t>(-.7 * R)}, {R, 0}},
...
static fixed_t scale_mtof = static_cast<int32_t>(INITSCALEMTOF);
