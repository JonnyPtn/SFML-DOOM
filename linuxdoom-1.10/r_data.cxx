...
void R_GenerateComposite(int texnum)
{
    ...
    for (const auto &patch : texture.patches)
    {
        ...
        for (; x < x2; x++)
        {
            ...
            auto *patchcol = (column_t *)((byte *)realpatch + LONG(realpatch->columnofs[x - x1]));
            R_DrawColumnInCache(patchcol, texturecomposite[texnum].data() + texturecolumnofs[texnum][x], patch.originy, texture.height);
        }
    }
}
